...
import 'pages/student_home_page.dart'; // Import Student HomePage
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/teacher_home': (context) => TeacherHomePage(), // Add Teacher HomePage route
        '/student_home': (context) => StudentHomePage(), // Add Student HomePage route
      },
    );
  }
}
